...
const PatientLimitations = ({ navigation }) => {
  ...
  const [selectedNightHour, setSelectedNightHour] = useState(hours[0]);
  const [selectedAfterNoonNaps, setSelectedAfterNoonNaps] = useState(hours[0]);
  ...
  const NavigateToNextLVL = () => {
    ...
    navigation.navigate('SignUpUserFinish');
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Modal animationType="slide" visible={modal5Visible}>
        <View style={styles.modal}>
          <Text style={styles.modalText}>Night Routine</Text>
          ...
          <Text style={styles.modalText}>After-Noon Routine</Text>
          <View style={styles.TimeContainer}>
            <Picker
              style={styles.pickerInside}
